...
namespace Paerowgee.GamepadAnimator
{
    ...
    public class GamepadAnimator
    {
        ...
        private static bool RewindAnimation()
        {
            ...
            bool forward = gamepadButtonStates[GamepadButton.RightShoulder].Pressed();
            bool backward = gamepadButtonStates[GamepadButton.LeftShoulder].Pressed();
            if (!forward && !backward)
            {
        ...
        static void DetermineInputState()
        {
            ...
            else if (inputState == InputState.RootInitiated)
            {
                ...
                else if (gamepadButtonStates[GamepadButton.LeftTrigger] == GamepadButtonPressedState.PressedThisFrame)
                {
                    ...
                    || gamepadButtonStates[GamepadButton.RightShoulder] == GamepadButtonPressedState.PressedThisFrame)
